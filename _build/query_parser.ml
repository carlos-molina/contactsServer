...
let rec _menhir_goto_list_tpl_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Config.tuple list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState2 ->
        ...
        | END ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _, q) = _menhir_stack in
            let _v : (Config.tuple list) =                                    (q) in
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let q = _v in
            let _v : (Config.tuple list) =              (q) in
...
and _menhir_goto_elem : _menhir_env -> 'ttv_tail -> _menhir_state -> (Config.context Config.element_type) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState12 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let ((((_menhir_stack, _menhir_s, s), _, p), _, o), _, c) = _menhir_stack in
        let _v : (Config.tuple) = ({Config.subj = s; Config.pred = p; Config.obj = o; Config.ctxt = c; Config.time_stp = None; Config.sign = None}) in
        let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
...
and _menhir_goto_parse : _menhir_env -> 'ttv_tail -> (Config.tuple list) -> 'ttv_return =
...
and parse : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Config.tuple list) =
  fun lexer lexbuf ->
